...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 text-center p-6 overflow-hidden animate-fadeIn">
      ...
      <a
        href="/html/link"
        className="mt-6 px-6 py-3 bg-gradient-to-r from-[#E47A5C] to-[#3AA199] text-white font-semibold rounded-xl hover:opacity-90 transition animate-slideUp delay-500">
        ← Back to Home
      </a>
    </div>
  );
